...
[src/lib/api-error.ts:8](https://github.com/seamapi/javascript-legacy/blob/main/src/lib/api-error.ts#L8)
...
[src/lib/api-error.ts:20](https://github.com/seamapi/javascript-legacy/blob/main/src/lib/api-error.ts#L20)
